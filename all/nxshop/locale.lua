...
Машины:
* Автомобили потребляют на 50% меньше топлива
* Выдаётся скидка 10% на приобретение транспорта
* Появляется доступ к аренде автомобилей
* Появляется опция изменения косметических частей на автомобилях (спойлеры, бамперы и прочее)
...
* Принтеры и рыбалка дают на 50% больше прибыли]],
		...
		premium_car_desc_1 = [[Эксклюзивный автомобиль Премиум-класса, добавляемый в список купленных машин навсегда.
	%d пассажирское сиденье.]],
		premium_car_desc_2 = [[Эксклюзивный автомобиль Премиум-класса, добавляемый в список купленных машин навсегда.
